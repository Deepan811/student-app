      ...
      <Sheet>
        ...
        <SheetContent side="right" className="w-[240px] flex flex-col p-0">
          <SheetHeader className="flex h-[60px] items-center border-b px-6">
            ...
            <SheetTitle className="sr-only">Trainer Menu</SheetTitle>
            <SheetDescription className="sr-only">A list of links to navigate the trainer section.</SheetDescription>
          </SheetHeader>
          <div className="flex-1 overflow-auto py-2">
            {renderNavLinks(true)}
          </div>
